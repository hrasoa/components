...
): (React.ComponentType<Props & PropsOut>) => React.ComponentType<Props> {
  return (WrappedComponent) => {
    class WithProvider extends React.Component<Props, State> {
      static defaultProps = {
        allowMultiple: false,
        allowTogle: false,
        className: null,
      ...
      static displayName = `AccordionProvider(${getDisplayName(WrappedComponent)})`;
